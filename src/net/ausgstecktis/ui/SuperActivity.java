         ...
         case R.id.mi_add_to_favorites:
            ...
            if (BaseActivity.newFavorite)
               UIUtils.showShortToast(
                     BaseApplication.mainContext.getResources().getString(R.string.toast_favorite_added));
            else
               UIUtils.showShortToast(
                     BaseApplication.mainContext.getResources().getString(R.string.toast_favorite_removed));
      }
   }
